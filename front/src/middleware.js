...
export function middleware(request) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://cekgetir.com https://api.cekgetir.com https://cekgetir.up.railway.app https://*.googleapis.com https://maps.googleapis.com https://maps.gstatic.com",
